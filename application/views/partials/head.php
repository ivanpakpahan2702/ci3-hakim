...
<head>
    ...
    <title>Subdit Hakim | <?= $title; ?></title>

    <!-- Google Font: Source Sans Pro -->
    <link rel="stylesheet"
        href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700&display=fallback">

    <!-- Font Awesome & overlayScrollbars (local) -->
    <link rel="stylesheet"
    ...
    <!-- DataTables (Bootstrap 5 integration, CDN) -->
    ...
    <!-- Buttons CSS: versi disamakan dengan script (3.2.5) -->
    <link rel="stylesheet" href="https://cdn.datatables.net/buttons/3.2.5/css/buttons.bootstrap5.min.css" />
    <link rel="stylesheet" href="https://cdn.datatables.net/columncontrol/1.1.1/css/columnControl.bootstrap5.css" />
    <!-- ColReorder CSS (sebelumnya hanya URL tanpa tag) -->
